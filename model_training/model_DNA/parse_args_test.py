...
def parse_args():
    ...
    # 网络参数
    #
    parser.add_argument('--backbone-mode', type=str, default='UNet', help='backbone mode: FPN, UNet, u2net')
    parser.add_argument('--fuse-mode', type=str, default='AsymBi', help='fuse mode: BiLocal, AsymBi, BiGlobal')
    parser.add_argument('--blocks-per-layer', type=int, default=6, help='blocks per layer')
